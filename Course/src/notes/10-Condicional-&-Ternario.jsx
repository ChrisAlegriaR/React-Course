...
function NombreComponente2() {
    ...
    return (
        <>
            ...
            <ol>
                <li>Despertarse: {booleano2 ? {} : {}}</li>
                <li>Correr: {booleano2 ? '' : '❌'}</li>
